...
```
Lastly, we tunning the parameter to see if we further minimize the error. 
```{r}
#tuning parameter
...
print(bestmtry)
```
mtry = 4 gives an accuracy of 94%; mtry: Number of variables randomly sampled as candidates at each split.
